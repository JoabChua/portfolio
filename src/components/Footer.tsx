  ...
  return (
    <footer className="is-primary is-small has-text-centered">
      <div className="container is-narrow pad-top">
        ...
        <h1 className="subtitle custom-color is-size-4-touch">
          Living, learning, &amp; leveling up one day at a time.
        </h1>
        <div className="social-icons">
          <p className="field">
            <a
              className="button is-medium footer-btn"
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.facebook.com/Joab.Chua"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://twitter.com/joabchua"
            >
              <span className="is-small icon">
                <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/JoabChua"
            >
              <span className="is-small icon">
                <img
                  src={require("../assets/social/github-logo.png")}
                  alt="github"
                />
              </span>
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.instagram.com/joabchua/"
            >
              <span className="is-small icon">
                <img
